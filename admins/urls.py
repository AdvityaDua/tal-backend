...
from .views import NewAdminView, AdminLoginView, AdminChangePasswordView, TokenRefreshView, TeamsView, TeamView, NotificationsView
...
urlpatterns = [
    ...
    path('teams/', TeamsView.as_view(), name='admin_teams'),
    path('teams/<str:team_id>/', TeamView.as_view(), name='admin_team_detail'),
